...
import { CustomerSelect, PriceInput } from '../../../components'
      ...
      <Modal wrapClassName={styles.wrap} visible={visible} onOk={onOk} onCancel={closeModal} confirmLoading={saving} {...modalProps}>
        <Form>
          ...
          <Form.Item className={styles.item} label='货款年月' required>
            <DatePicker picker='month' value={value?.goodsTime ? moment(value.goodsTime) : null} onChange={onMoneyDateChange} allowClear={false} />
          </Form.Item>
